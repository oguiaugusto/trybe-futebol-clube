...
import allByProgressCondition from './mocks/leaderboard/allByProgressCondition';
import endedMatchesByTeam from './mocks/leaderboard/endedMatchesByTeam';
import expectedLeaderBoard from './mocks/leaderboard/leaderboard';
...
describe('Endpoint GET /leaderboard', () => {
  const chaiHttpResponse = async () => chai.request(app).get('/leaderboard');
